use amethyst::{
    derive::SystemDesc,
    ecs::{System, SystemData, Read, WriteStorage},
...
use amethyst::core::ecs::{ReadExpect, ReadStorage, Join};
...
impl<'s> System<'s> for PlayerUpdateSystem {
    ...
    fn run(&mut self, (player_updates_channel, net_ids, mut healths, mut weapons, player_net_id): Self::SystemData) {
